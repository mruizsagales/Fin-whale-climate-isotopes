...
ggsave("/Users/marcruizisagales/Documents/GitHub/Climate-baleen-plate-isotopes/png/Figure_S4_Isotopic_time_series_per_years.png", last_plot(), 
       dpi = 300,  width = 15, height = 20, units = "cm")
